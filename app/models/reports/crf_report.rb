...
private
  ...
  def crf_body(form, options)
    ...
    html += "table.crf-input-field tr td { font-family: Arial, \"Helvetica Neue\", Helvetica, sans-serif; font-size: 8pt; text-align: "
    html += "center; vertical-align: center; padding: 5px; }\n"
...
=end    
  ...
  def crf_node(node, annotations, options)
    html = ""
