...
module Sparql
  ...
  class Statement
    ...
    def initialize(args, default_namespace, prefix_set) 
      @item = 
        [
          Sparql::Statement::Uri.new(args[:subject], default_namespace, prefix_set),
          Sparql::Statement::Uri.new(args[:predicate], default_namespace, prefix_set),
  ...
  private
    ...
    def add_object(args, default_namespace, prefix_set)
      return Sparql::Statement::Literal.new(args) if args.key?(:literal) 
      Sparql::Statement::Uri.new(args, default_namespace, prefix_set)
    end
