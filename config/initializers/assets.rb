...
Rails.application.config.assets.precompile += %w( shared/iso_managed/managed_children_panel.js shared/iso_managed/children_panel.js )
Rails.application.config.assets.precompile += %w( shared/thesauri/changes_panel.js shared/thesauri/search.js)
Rails.application.config.assets.precompile += %w( cdisc_term/history.js cdisc_term/changes.js cdisc_term/search.js)
Rails.application.config.assets.precompile += %w( thesauri/show.js thesauri/search.js thesauri/search_current.js thesauri/managed_concepts/show.js thesauri/unmanaged_concepts/show.js)
