...
Rails.application.config.assets.precompile += %w( shared/thesauri/changes_panel.js shared/thesauri/thesauri_search_panel.js shared/thesauri/new_panel.js)
Rails.application.config.assets.precompile += %w( cdisc_term/history.js )
Rails.application.config.assets.precompile += %w( thesauri/show.js thesauri/search.js thesauri/search_current.js thesauri/changes.js thesauri/edit.js)
