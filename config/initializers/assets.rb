...
Rails.application.config.assets.precompile += %w( shared/iso_managed/managed_children_panel.js )
Rails.application.config.assets.precompile += %w( shared/thesauri/changes_panel.js )
Rails.application.config.assets.precompile += %w( cdisc_term/history.js cdisc_term/changes.js cdisc_term/show.js)
