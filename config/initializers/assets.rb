...
%w( iso_concept_systems iso_concept_systems/nodes iso_concept_system_editor 
  iso_registration_authorities iso_registration_states iso_namespaces iso_managed iso_scoped_identifiers 
