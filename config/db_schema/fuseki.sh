set -x
curl -X POST -H "Content-Type:multipart/form-data" -F "filename=@ISO11179Types.ttl" http://192.168.2.101:3030/mdr/data
curl -X POST -H "Content-Type:multipart/form-data" -F "filename=@ISO11179Basic.ttl" http://192.168.2.101:3030/mdr/data
curl -X POST -H "Content-Type:multipart/form-data" -F "filename=@ISO11179Identification.ttl" http://192.168.2.101:3030/mdr/data
curl -X POST -H "Content-Type:multipart/form-data" -F "filename=@ISO11179Registration.ttl" http://192.168.2.101:3030/mdr/data
curl -X POST -H "Content-Type:multipart/form-data" -F "filename=@ISO11179Data.ttl" http://192.168.2.101:3030/mdr/data
curl -X POST -H "Content-Type:multipart/form-data" -F "filename=@ISO11179Concepts.ttl" http://192.168.2.101:3030/mdr/data
curl -X POST -H "Content-Type:multipart/form-data" -F "filename=@ISO25964.ttl" http://192.168.2.101:3030/mdr/data
...
curl -X POST -H "Content-Type:multipart/form-data" -F "filename=@CT_V42.ttl" http://192.168.2.101:3030/mdr/data
