@A3VAL-1036
Feature: pPQ Sanofi PROD R3.7.0: Test Execution for Test Plan A3VAL-1033
	...
	Scenario: Terminology - view of additional metadata attributes to a managed item or child element
		...
		|Identifier,Submission Value,Preferred Term,Synonyms,Definition,Tags,CRF Display Value,ADaM Stage,DC Stage,SDTM Stage|
		When I enter "C96658" in the search area
		Then I see the following attributes for "C96658" of 2019 Release 1:
		|Identifier|SubmissionValue|PreferredTerm|Synonyms|Definition|Tags|CRFDisplayValue|ADaMStage|DCStage|SDTMStage|
		|C96658    |SISTER, BIOLOGICAL MATERNAL HALF|Half-sister with Mother as Common Parent|Half-sister with Mother as Common Parent|A female who shares with her sibling the genetic makeup inherited from only the biological mother.|SDTM|Biological Maternal Half Sister|false|true|true|
