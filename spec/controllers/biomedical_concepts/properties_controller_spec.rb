...
describe BiomedicalConcepts::PropertiesController do
  ...
  describe "Curator User" do
    ...
    it "gets the property, JSON" do  
      ...
      #write_text_file_2(response.body, sub_dir, "property_show.txt")
    ...
    it "prevents property being updated if not locked" do
      ...
      #write_text_file_2(response.body, sub_dir, "property_update_no_lock.txt")
    ...
    it "allows property to be updated" do
      ...
      expect(response.content_type).to eq("application/json")
      expect(response.code).to eq("200")
      #write_text_file_2(response.body, sub_dir, "property_update_1.txt")
    ...
    it "allows property to be updated, not first" do
      ...
      expect(response.content_type).to eq("application/json")
      expect(response.code).to eq("200")
      #write_text_file_2(response.body, sub_dir, "property_update_2.txt")
    ...
    it "prevents terms being added if not locked" do
      ...
      expect(response.content_type).to eq("application/json")
      expect(response.code).to eq("422")
      #write_text_file_2(response.body, sub_dir, "property_add_no_lock.txt")
    ...
    #puts response.body
      ...
      expect(AuditTrail.count).to eq(audit_count + 1)
      bc = BiomedicalConceptCore.find("BC-ACME_BC_C25347", "http://www.assero.co.uk/MDRBCs/V1")
      #write_yaml_file(bc.to_json, sub_dir, "property_add_1.yaml")
    ...
    it "prevents terms being removed if not locked"  do
      ...
      expect(response.content_type).to eq("application/json")
      expect(response.code).to eq("422")
      #write_text_file_2(response.body, sub_dir, "property_remove_no_lock.txt")
