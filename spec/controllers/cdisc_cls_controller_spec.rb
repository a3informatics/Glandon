...
describe CdiscClsController do
  ...
  describe "Authorized User" do
    ...
    it "calculates all changes for a code list" do
      params = {id: "CL-C66741", cdisc_cl: {namespace: "http://www.assero.co.uk/MDRThesaurus/CDISC/V39"}}
      get :changes, params
      results = assigns(:results)
    #Xwrite_yaml_file(results, sub_dir, "cdisc_cl_controller_changes_1.yaml")
      expected = read_yaml_file(sub_dir, "cdisc_cl_controller_changes_1.yaml")
      expect(results).to eq(expected)
      clis = assigns(:clis)
    #Xwrite_yaml_file(clis, sub_dir, "cdisc_cl_controller_changes_2.yaml")
      expected = read_yaml_file(sub_dir, "cdisc_cl_controller_changes_2.yaml")
      expect(clis).to eq(expected)
    end
    
    it "calculates all changes for a code list" do
      params = {id: "CL-C120521", cdisc_cl: {namespace: "http://www.assero.co.uk/MDRThesaurus/CDISC/V40"} }
      get :changes, params
      results = assigns(:results)
    #Xwrite_yaml_file(results, sub_dir, "cdisc_cl_controller_changes_3.yaml")
      expected = read_yaml_file(sub_dir, "cdisc_cl_controller_changes_3.yaml")
      expect(results).to eq(expected)
      clis = assigns(:clis)
    #Xwrite_yaml_file(clis, sub_dir, "cdisc_cl_controller_changes_4.yaml")
      expected = read_yaml_file(sub_dir, "cdisc_cl_controller_changes_4.yaml")
      expect(clis).to eq(expected)
    end

    it "calculates all changes for a code list" do
      params = {id: "CL-C100145", cdisc_cl: {namespace: "http://www.assero.co.uk/MDRThesaurus/CDISC/V39"} }
      get :changes, params
      results = assigns(:results)
    #Xwrite_yaml_file(results, sub_dir, "cdisc_cl_controller_changes_5.yaml")
      expected = read_yaml_file(sub_dir, "cdisc_cl_controller_changes_5.yaml")
      expect(results).to eq(expected)
      clis = assigns(:clis)
    #Xwrite_yaml_file(clis, sub_dir, "cdisc_cl_controller_changes_6.yaml")
    ...
    #Xwrite_yaml_file(results.to_json, sub_dir, "cdisc_cl_controller_show.yaml")
