...
describe AdamIgDatasetsController do
  ...
  describe "Reader User" do
    ...
    before :all do
      data_files = ["iso_namespace_real.ttl", "iso_registration_authority_real.ttl", "thesaurus.ttl", "ADAM_IG_1-0-0 Draft.ttl"]
    ...
    it "show" do
      adam_ig_dataset = AdamIgDataset.find_minimum(Uri.new(uri: "http://www.assero.co.uk/MDRAdamIgT/CDISC/V1#AIG-CDISC_ADAMIGBDS"))
