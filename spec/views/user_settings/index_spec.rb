...
describe 'user_settings/index.html.erb', :type => :view do
  ...
  it 'displays user details correctly, I' do
    ...
    expect(rendered).to_not have_selector("table#user_settings tbody tr:nth-of-type(4) td:nth-of-type(1) a")
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(5) td:nth-of-type(1) a", text: 'A4')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(6) td:nth-of-type(1) a", text: '10')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(7) td:nth-of-type(1) a", text: '4')
    ...
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(5) td:nth-of-type(1) a:nth-of-type(2)", text: 'A3')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(5) td:nth-of-type(1) a:nth-of-type(3)", text: 'Letter')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(6) td:nth-of-type(1) a:nth-of-type(2)", text: '5')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(6) td:nth-of-type(1) a:nth-of-type(3)", text: '15')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(6) td:nth-of-type(1) a:nth-of-type(4)", text: '25')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(6) td:nth-of-type(1) a:nth-of-type(5)", text: '50')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(6) td:nth-of-type(1) a:nth-of-type(6)", text: '100')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(6) td:nth-of-type(1) a:nth-of-type(7)", text: 'All')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(7) td:nth-of-type(1) a:nth-of-type(2)", text: '8')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(7) td:nth-of-type(1) a:nth-of-type(3)", text: '12')
  ...
  it 'displays user details correctly, II' do
    ...
    expect(rendered).to_not have_selector("table#user_settings tbody tr:nth-of-type(4) td:nth-of-type(1) a")
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(5) td:nth-of-type(1) a", text: 'A4')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(6) td:nth-of-type(1) a", text: '25')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(7) td:nth-of-type(1) a", text: '4')
    ...
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(5) td:nth-of-type(1) a:nth-of-type(3)", text: 'Letter')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(6) td:nth-of-type(1) a:nth-of-type(2)", text: '5')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(6) td:nth-of-type(1) a:nth-of-type(3)", text: '10')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(6) td:nth-of-type(1) a:nth-of-type(4)", text: '15')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(6) td:nth-of-type(1) a:nth-of-type(5)", text: '50')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(6) td:nth-of-type(1) a:nth-of-type(6)", text: '100')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(6) td:nth-of-type(1) a:nth-of-type(7)", text: 'All')
    expect(rendered).to have_selector("table#user_settings tbody tr:nth-of-type(7) td:nth-of-type(1) a:nth-of-type(2)", text: '8')
