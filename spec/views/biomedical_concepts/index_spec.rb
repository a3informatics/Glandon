...
describe 'biomedical_concepts/index.html.erb', :type => :view do
  ...
  it 'displays product details correctly, edit and new enabled' do
    ...
    bcs = []
    bcs << { :owner => "ABC", :identifier => "ID1", :label => "Number 1", :scope_id => "ABC_ID" }
    bcs << { :owner => "ABC", :identifier => "ID2", :label => "Number 2", :scope_id => "ABC_ID" } 
    bcs << { :owner => "XYZ", :identifier => "ID3", :label => "Number 3", :scope_id => "XYZ_ID" } 
    assign(:bcs, bcs)
