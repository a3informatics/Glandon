...
describe "CDISC Term", :type => :feature do
  ...
  describe "CDISC Terminology. Curator Login", :type => :feature do
    ...
    it "shows version 1 (GLAN-652) (REQ-MDR-CT-031)", js:true do
      ...
      ui_check_table_info("children", 1, 10, 32)
      click_link 'Return'
      expect(page).to have_content 'History'
    end
    ...
    it "allows the entries in a CDISC Terminology code list can be viewed (REQ-MDR-CT-070)", js:true do
      ...
      ui_check_table_info("children", 1, 10, 446)
      ui_child_search("10013")
      ui_check_table_info("children", 1, 10, 10)
      ...
      wait_for_ajax(10)
      expect(page).to have_content 'EQ-5D-3L TESTCD'
      ui_check_table_info("children", 1, 6, 6)
    ...
    it "Checks CDISC CL table columns (REQ-MDR-CT-???)", js:true do
      ...
      wait_for_ajax 10
      expect(page).to have_content 'EQ-5D-3L TESTCD'
      ui_check_table_head("children_wrapper", 1, "Identifier")
      ui_check_table_head("children_wrapper", 2, "Submission Value")
      ui_check_table_head("children_wrapper", 3, "Preferred Term")
      ui_check_table_head("children_wrapper", 4, "Synonyms")
      ui_check_table_head("children_wrapper", 5, "Definition")
      ui_check_table_head("children_wrapper", 6, "Tags")
    end
    ...
    it "allows the details of an entry in a CDISC Terminology code list can be viewed (REQ-MDR-CT-070)", js:true do
      ...
      wait_for_ajax(7)
      ui_check_table_info("children", 1, 10, 123)
      ...
      wait_for_ajax(7)
      ui_check_table_info("children", 1, 5, 5)
    ...
    it "allows the submission value with changes to be viewed (REQ-MDR-CT-050)", js:true do
      click_navbar_cdisc_terminology
      expect(page).to have_content 'History'
      click_link 'Submission value changes'
