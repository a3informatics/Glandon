...
describe "Scenario 6 - CRF & aCRF", :type => :feature do
  ...
  describe "Curator User", :type => :feature do
    ...
    before :all do
      ...
      load_test_file_into_triple_store("ACME_BC_C100392_STD.ttl")
      load_test_file_into_triple_store("ACME_BC_C100393_STD.ttl")
      load_test_file_into_triple_store("ACME_BC_C100394_STD.ttl")
      load_test_file_into_triple_store("ACME_BC_C100395_STD.ttl")
      load_test_file_into_triple_store("ACME_BC_C100396_STD.ttl")
      load_test_file_into_triple_store("ACME_BC_C100397_STD.ttl")
      load_test_file_into_triple_store("sdtm_model_and_ig.ttl")
      load_test_file_into_triple_store("ACME_QS_Domain_DFT.ttl")
      load_test_file_into_triple_store("ACME_EQ5D3L_DFT.ttl")
