...
describe "Biomedical Concept Instances Editor", :type => :feature do
  ...
  describe "Edit BC", :type => :feature, js:true do
    ...
    it "allows access to edit page, initial state" do
      ...
      ui_check_table_cell 'editor', 1, 8, 'HEIGHT C25347 (VSTESTCD C66741 v5.0.0)'
    ...
    it "allows to edit a single BC, terminology selection" do
      ...
      ui_editor_select_by_location 6, 8, offset_y: 70
      ...
      ui_editor_check_value 6, 8, 'm C41139 (UNIT C71620 v10.0.0)'
      ui_editor_check_value 6, 8, 'cm C49668 (VSRESU C66770 v10.0.0)'
    ...
    it "prevents adding more than one Terminology Reference to a TESTCD BC Property" do
      ...
      ui_editor_check_value 1, 8, 'HEIGHT C25347 (VSTESTCD C66741 v5.0.0)'
    ...
    it "allows adding BCs to Editor, prevents duplicates" do
      ...
      ui_check_table_info 'editor', 1, 10, 12
      ui_editor_check_value 1, 8, 'WEIGHT C25208 (VSTESTCD C66741 v5.0.0)'
    ...
    it "allows to edit multiple BCs, inline fields" do
      ...
      # Inline text
      ui_editor_select_by_content 'Body Position', offset_y: 70
    ...
    it "allows to edit multiple BCs, terminology selection" do
      ...
      # Add Term Reference
      ui_editor_select_by_content 'ARM C32141', offset_y: 70
      ...
      ui_editor_select_by_location 9, 8, offset_y: 70
