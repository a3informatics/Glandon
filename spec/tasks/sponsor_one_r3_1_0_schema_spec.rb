...
describe 'sponsor one R3.1.0 schema migration' do
  
  before :all do
    Rake.application.rake_require "tasks/sponsor_one_r3_1_0_schema"
    Rake::Task.define_task(:environment)
  end

  def sub_dir
    return "tasks/sponsor_one/r3_1_0_schema"
  end

  describe 'sponsor one R3.1.0 schema' do
    ...
    let :run_rake_task do
      Rake::Task["sponsor_one:r3_1_0_schema"].reenable
      Rake.application.invoke_task "sponsor_one:r3_1_0_schema"
    end
