...
module DataHelpers
  ...
  def schema_files
    [
      ...
      "users_and_roles.ttl", "business_operational.ttl", "thesaurus.ttl", "annotations.ttl", "complex_datatype.ttl",
  ...
  def set_transactional_tests(value)
    self.use_transactional_tests = value
  end
