...
describe BreadcrumbsHelper do
  ...
  describe "breadcrumb" do
    ...
    it "single item" do
  	...
  	it "first level" do
    	#helper.first_level_breadcrumb(:users)
      helper.first_level_breadcrumb(:users)
      expected = "<ol class=\"breadcrumb\"><li id=\"breadcrumb_1\" class=\"active\">Users</li></ol>"
      expect(session[:breadcrumbs]).to eq(expected)
    end

  	it "second level" do
    	helper.second_level_breadcrumb(:users, IsoNamespace.find_by_short_name("BBB").id, "XXX") 
      expected = "<ol class=\"breadcrumb\"><li id=\"breadcrumb_1\"><a href=\"/users\">Users</a></li><li " + 
      ...
      item.has_identifier.semantic_version = "1.2.3"
    	helper.third_level_breadcrumb(:users, item, "/test/level2")
      expected = "<ol class=\"breadcrumb\"><li id=\"breadcrumb_1\"><a href=\"/users\">Users</a></li><li id=\"breadcrumb_2\"><a " + 
      ...
      item.has_identifier.has_scope = IsoNamespace.new(uri: Uri.new(uri: "http://www.assero.co.uk/NS#DDD"), name: "DDD Long", short_name: "DDD", authority: "www.ddd.com")
      item.has_identifier.semantic_version = "1.2.3"
    	helper.fourth_level_breadcrumb(:users, item, "/test/level2", "/test/level3", "Action 4")
      expected = "<ol class=\"breadcrumb\"><li id=\"breadcrumb_1\"><a href=\"/users\">Users</a></li><li id=\"breadcrumb_2\"><a " + 
