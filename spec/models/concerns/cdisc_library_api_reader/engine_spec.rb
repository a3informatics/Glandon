...
describe CDISCLibraryAPIReader::Engine do
  ...
  it "process sdtm", :speed => 'slow', :requires => 'cdisc_library_api' do
    parent = IsoConceptV2.new
    object = CDISCLibraryAPIReader::Engine.new(parent) 
  ...
  it "process send", :speed => 'slow', :requires => 'cdisc_library_api' do
    parent = IsoConceptV2.new
    object = CDISCLibraryAPIReader::Engine.new(parent) 
  ...
  it "process adam", :speed => 'slow', :requires => 'cdisc_library_api' do
    parent = IsoConceptV2.new
    object = CDISCLibraryAPIReader::Engine.new(parent) 
