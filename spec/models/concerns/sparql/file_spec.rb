...
describe Sparql::File do
  ...
  it "loads a file, error" do
    ...
    expect{@test_class.upload(filename)}.to raise_error(Errors::CreateError, "Failed to upload and create an item in the database.")
