...
describe Timestamp do
  ...
  it "allows for the class to be created with an initial value" do
    ...
    expect(timestamp.to_json).to eq("{\"time\":\"2016-11-04T00:00:00.000+00:00\"}")
  end

  it "allows the time to be set" do
    timestamp = Timestamp.new()
    timestamp.from_timestamp("2016-11-04 16:00:01")
    expect(timestamp.to_json).to eq("{\"time\":\"2016-11-04T16:00:01.000+00:00\"}")
  end
  ...
  it "supports multiple output formats" do
    ...
    expect(timestamp.to_8601).to eq("2016-11-04T16:00:01+00:00")
  end
