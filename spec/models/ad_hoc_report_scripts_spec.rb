...
RSpec.describe AdHocReport, type: :model do
  ...
  #   copy_report_to_public_files("ct_ref_inconsistencies_sparql.yaml", "test")
  #   job = Background.create
  #   report = AdHocReport.new
  #   report.background_id = job.id
  #   report.sparql_file = "ct_ref_inconsistencies_sparql.yaml"
  #   report.results_file = "ct_ref_inconsistencies_results_1.yaml"
  #   job.start("Rspec test", "Starting...") {report.execute([Uri.new(uri: "http://www.acme-pharma.com/AIRPORTS/V1#TH").to_id])}
  #   results = AdHocReportFiles.read("ct_ref_inconsistencies_results_1.yaml")
  #   check_file_actual_expected(results, sub_dir, "ct_ref_inconsistencies_expected_1.yaml")
  # end
