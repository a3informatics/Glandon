...
RSpec.describe AdHocReport, type: :model do
  ...
  describe "Sponsor Export Tests" do
    ...
    it "executes an sponsor CT export report, 2019", :ad_hoc_report => 'slow' do
      ...
      save_selected_results(results, "sponsor_ct_export_selected_results_1.yaml", ["ACN_01", "ACN_03", "AERELA","SUAM_01", "LOC_01", "RACEC", "TRTEST", "NSA-16 TESTCD", "COWS TESTCD", "OUT", "AESEV"], true)
    ...
    it "executes an sponsor CT export report, 2020 R1", :ad_hoc_report => 'slow' do
      ...
      save_selected_results(results, "sponsor_ct_export_selected_results_2.yaml", ["ACN_01", "ACN_03", "AERELA", "SUAM_01", "LOC_01", "RACEC", "TRTEST", "NSA-16 TESTCD", "COWS TESTCD", "OUT", "AESEV"], true)
      ranks = extract_ranks(results)
    ...
    it "executes an sponsor CT export report, 2020 R2", :ad_hoc_report => 'slow' do
      ...
      save_selected_results(results, "sponsor_ct_export_selected_results_3.yaml", ["ACN", "AERELA", "AERELDEV_01", "AGEGRPE", "AGEGRPPN", "NORMEDN", "SEVRS", "SHIFT2N", "TOXGR_01", "TOXGRN"], true)
      ranks = extract_ranks(results)
