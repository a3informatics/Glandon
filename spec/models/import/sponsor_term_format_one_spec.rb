...
puts colourize("Load 2.6 excel ...", "blue")
    ...
    params = {identifier: "Q1 2020", version: "1", date: "2019-11-22", files: [full_path], version_label: "1.0.0", label: "Version 2-6 Test Upgrade", semantic_version: "1.0.0", job: @job, uri: ct.uri}
    result = @object.import(params)
    filename = "sponsor_term_format_one_#{@object.id}_errors.yml"
    #expect(public_file_does_not_exist?("test", filename)).to eq(true)
