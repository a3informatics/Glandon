...
describe "Import::SponsorTermFormatOne" do
  ...
  it "import, no errors, version 2, short IV" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_8.yaml")
  ...
  it "import, no errors, rank, short VI" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_22.yaml")
  ...
  it "import, no errors, 1st AGEU version" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_24a.yaml")
  ...
  it "import, no errors, 1st ABTESTCD version" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_25a.yaml")
  ...
  it "import, no errors, 2nd ABTESTCD version" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_25b.yaml")
  ...
  it "import, no errors, 1st EDUCATE version" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_26a.yaml")
  ...
  it "import, no errors, 2nd EDUCATE version" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_26b.yaml")
  ...
  it "import, EPOCH code list" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_30a.yaml")
  ...
  it "import, SEVRS code list" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_31a.yaml")
  ...
  it "import, AERELA code list" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_32a.yaml")
  ...
  it "import, AERELA and Subset code list with Custom Check" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_33.yaml")
  ...
  it "import, no errors, 1st ACSPCAT version" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_34a.yaml")
  ...
  it "import, no errors, 2nd ACSPCAT version" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_34b.yaml")
  ...
  it "import, no errors, 1st DICTNAM version" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_35a.yaml")
  ...
  it "import, no errors, 2nd DICTNAM version" do
    ...
    #public_file_does_not_exist?("test", filename)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_35b.yaml")
...
puts colourize("Load 3.0 excel ...", "blue")
    ...
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_10.yaml")
...
puts colourize("Load 3.0 excel ...", "blue")
    ...
    #expect(public_file_does_not_exist?("test", filename)).to eq(true)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_11.yaml")
  ...
  it "import, no errors, bug issue III" do
    ...
    #expect(public_file_does_not_exist?("test", filename)).to eq(true)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_12.yaml")
  ...
  it "import, no errors, bug issue IV" do
    ...
    #expect(public_file_does_not_exist?("test", filename)).to eq(true)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_14.yaml")
  ...
  it "import, no errors, bug issue VI" do
    ...
    #expect(public_file_does_not_exist?("test", filename)).to eq(true)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_16.yaml")
  ...
  it "import, no errors, bug issue VII" do
    ...
    #expect(public_file_does_not_exist?("test", filename)).to eq(true)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_17.yaml")
  ...
  it "import, no errors, bug issue VIII" do
    ...
    #expect(public_file_does_not_exist?("test", filename)).to eq(true)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_18.yaml")
  ...
  it "import, no errors, bug issue IX" do
    ...
    #expect(public_file_does_not_exist?("test", filename)).to eq(true)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_20.yaml")
  ...
  it "import, no errors, rank I" do
    ...
    #expect(public_file_does_not_exist?("test", filename)).to eq(true)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_21.yaml")
  ...
  it "import, no errors, rank II" do
    ...
    #expect(public_file_does_not_exist?("test", filename)).to eq(true)
    actual = read_public_yaml_file("test", filename)
  copy_file_from_public_files_rename("test", filename, sub_dir, "import_errors_expected_23.yaml")
