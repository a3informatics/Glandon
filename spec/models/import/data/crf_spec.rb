...
describe Import::Crf do
  ...
  copy_file_from_public_files_rename("test", filename, sub_dir, "FORM_DM.ttl")
  ...
  it "CDISC aCRF Library - VS" do
    ...
    result = Import.find(@object.id)
    filename = File.basename(result.output_file)
  copy_file_from_public_files_rename("test", filename, sub_dir, "FORM_VS.ttl")
    copy_file_from_public_files("test", filename, sub_dir)
  ...
  it "CDISC aCRF Library - PE" do
    ...
    result = Import.find(@object.id)
    filename = File.basename(result.output_file)
  copy_file_from_public_files_rename("test", filename, sub_dir, "FORM_PE.ttl")
    copy_file_from_public_files("test", filename, sub_dir)
