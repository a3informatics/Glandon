...
describe "Import CDISC SDTM Model Data" do
  ...
  def process_model(version, date, files, copy_file=false)
    ...
    filename = "sdtm_model_#{@object.id}_errors.yml"
    dump_errors_if_present(filename, version, date)
    expect(public_file_does_not_exist?("test", filename)).to eq(true)
    filename = "sdtm_model_#{@object.id}_load.ttl"
  ...
  def create_maps
    @date_to_version_map = [
      "2008-11-12", "2012-07-16", "2007-04-26", "2007-05-31", "2007-06-05" # 1
    ]
  ...
  describe "all versions" do
    ...
    it "Base create, 1-2", :speed => 'slow' do
      ...
      results = execute_import(release_date, set_write_file, use_api)
  ...
  describe "2020" do
    ...
    it "Create 2020-05-08", :speed => 'slow' do
