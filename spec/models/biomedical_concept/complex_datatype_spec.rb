...
describe BiomedicalConcept::ComplexDatatype do
  ...
  #   item = BiomedicalConcept::ComplexDatatype.new(triples, "N_1")
  ...
  #     }
  #   item = BiomedicalConcept::ComplexDatatype.new
  #   item.id = "123"
  ...
  #       :type => "http://www.example.com/path#rdf_test_type"
  #     }
  #   expect(BiomedicalConcept::ComplexDatatype.from_json(result).to_json).to eq(result)
  # end
  ...
  #     ]
  #   }
  #   item = BiomedicalConcept::ComplexDatatype.from_json(result)
  #   parent_uri = UriV2.new({:id => "XXX", :namespace => "http://www.example.com/path"})
  #   item.to_sparql_v2(parent_uri, sparql)
