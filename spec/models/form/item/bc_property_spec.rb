...
describe Form::Item::BcProperty do
  ...
  describe "To aCRF tests" do
    ...
    it "to aCRF I" do
      ...
      result = bc_property.to_crf(annotations)
  ...
  describe "Make common tests" do
    ...
    it "make common III, check terminologies" do
      ...
      bci_2 = BiomedicalConceptInstance.find_full(Uri.new(uri: "http://www.s-cubed.dk/BMI/V1#BCI"))
      bci_3 = BiomedicalConceptInstance.find_full(Uri.new(uri: "http://www.s-cubed.dk/RACE/V1#BCI"))
