...
describe Form::Group do
  ...
  describe "Destroy" do
    ...
    it "deletes Normal group IV" do
      ...
      group = Form::Group::Normal.find(Uri.new(uri: "http://www.example.com/A#NG_4646b47a-4ae4-4f21-b5e2-565815c8cded"))
      result = group.delete(normal_2, normal_2)
      normal_2 = Form::Group::Normal.find_full(normal_2.uri)
      expect{Form::Group::Normal.find(Uri.new(uri: "http://www.example.com/A#NG_4646b47a-4ae4-4f21-b5e2-565815c8cded"))}.to raise_error(Errors::NotFoundError, "Failed to find http://www.example.com/A#NG_4646b47a-4ae4-4f21-b5e2-565815c8cded in Form::Group::Normal.")
      check_file_actual_expected(result, sub_dir, "delete_normal_group_expected_2b.yaml", equate_method: :hash_equal)
      common_group = Form::Group::Common.find(Uri.new(uri: "http://www.example.com/A#CG_1760cbb1-a370-41f6-a3b3-493c1d9c2238"))
  ...
  describe "Destroy BC Group" do
    ...
    it "deletes BC group and common item" do
      ...
      normal_1.save
      normal_1 = Form::Group::Normal.find_full(normal_1.uri)
      bc_property = Form::Item::BcProperty.find(Uri.new(uri: "http://www.example.com/A#BCP_92bf8b74-ec78-4348-9a1b-154a6ccb9b9f"))
      ...
      group = Form::Group::Bc.find(Uri.new(uri: "http://www.example.com/A#BCG_4646b47a-4ae4-4f21-b5e2-565815c8cded"))
      result = group.delete(normal_1, normal_1)
      normal_1 = Form::Group::Normal.find_full(normal_1.uri)
      expect{Form::Group::Bc.find(Uri.new(uri: "http://www.example.com/A#BCG_4646b47a-4ae4-4f21-b5e2-565815c8cded"))}.to raise_error(Errors::NotFoundError, "Failed to find http://www.example.com/A#BCG_4646b47a-4ae4-4f21-b5e2-565815c8cded in Form::Group::Bc.")
      expect{Form::Item::Common.find(Uri.new(uri: "http://www.example.com/A#CI_f03287d6-23ea-43bb-b3cf-f972761caabd"))}.to raise_error(Errors::NotFoundError, "Failed to find http://www.example.com/A#CI_f03287d6-23ea-43bb-b3cf-f972761caabd in Form::Item::Common.")
    ...
    it "deletes BC group, doesn't delete common item" do
      ...
      common_item = Form::Item::Common.find(Uri.new(uri: "http://www.example.com/A#CI_16815e87-0141-4de3-b575-f06a729bdf40"))
      group = Form::Group::Bc.find(Uri.new(uri: "http://www.example.com/A#BCG_4646b47a-4ae4-4f21-b5e2-565815c8cded"))
      result = group.delete(normal_1, normal_1)
      expect{Form::Group::Bc.find(Uri.new(uri: "http://www.example.com/A#BCG_4646b47a-4ae4-4f21-b5e2-565815c8cded"))}.to raise_error(Errors::NotFoundError, "Failed to find http://www.example.com/A#BCG_4646b47a-4ae4-4f21-b5e2-565815c8cded in Form::Group::Bc.")
      common_item = Form::Item::Common.find(Uri.new(uri: "http://www.example.com/A#CI_16815e87-0141-4de3-b575-f06a729bdf40"))
