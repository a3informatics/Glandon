...
describe Thesaurus do
  ...
  it "code list changes" do
    expected = 
    {
      ...
      C78417:  [:~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :C, :D, :~, :~, :~, :C, :-, :D, :C, :U, :-, :-, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :-, :-, :-, :-, :-], #
      C100143: [:~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :-, :-, :-, :-, :-, :-, :-, :U, :-, :-, :-, :U, :-, :U, :-, :D, :C, :-, :-, :-, :U, :U, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-], # NPI1TN <<< Check
      C100150: [:~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :U, :-, :-, :-, :-, :-, :-, :U, :U, :-, :-, :-, :-, :D, :~, :~, :~, :~, :~, :~, :~, :~], # CGI01TC <<< Check
      C100151: [:~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :-, :-, :-, :-, :-, :-, :~, :~, :~, :~, :~, :~, :C, :U, :-, :-, :-, :-, :-, :-, :U, :U, :-, :-, :-, :-, :D, :~, :~, :~, :~, :~, :~, :~, :~],
      C100161: [:~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :-, :-, :-, :-, :-, :-, :~, :~, :~, :~, :~, :~, :C, :U, :-, :-, :-, :-, :-, :-, :U, :U, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-],
      C100169: [:~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :-, :-, :-, :-, :-, :-, :~, :~, :~, :~, :~, :~, :C, :U, :-, :-, :-, :-, :-, :-, :U, :U, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-],
      C101808: [:~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :-, :-, :-, :-, :-, :-, :~, :~, :~, :~, :~, :~, :C, :U, :-, :-, :-, :-, :-, :-, :U, :U, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-, :-],
      ...
      C141655: [:~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :-, :-, :-, :-, :-, :-, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :C, :-, :-, :-, :-, :-, :-],
      C142187: [:~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :-, :-, :-, :-, :-, :-, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :C, :-, :-, :-, :-, :-, :-],
      C67152:  [:~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :-, :-, :-, :-, :-, :-, :-, :U, :U, :-, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :-, :U, :U, :U, :-, :-, :-, :-, :-, :-], # TSPARM 
      C71620:  [:~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :-, :-, :-, :-, :-, :-, :U, :U, :U, :U, :U, :U, :U, :U, :U, :-, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U, :U], # UNIT
      C120522: [:~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :C, :D, :~, :~, :~, :C, :-, :-, :-, :-, :-, :-, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :~, :C, :U, :-, :-, :-, :-, :-, :-, :-, :U, :-, :U, :-, :-, :-, :-, :-, :U]  # HESTRESC
    }
