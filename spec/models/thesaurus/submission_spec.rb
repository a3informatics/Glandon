...
describe Thesaurus do
  ...
  def check_submission(actual, expected)
    result = true
    expected[:expected].each do |expect|
  ...
  it "submission changes" do
    expected =
    [
      { version: 1, date: "2007-03-60", expected: [] },
      { version: 2, date: "2007-04-20", expected:
        [ 
          {key: :C65047_C64809, previous: "NA", notation: "SODIUM" }
        ]
      },
      { version: 3, date: "2007-04-26", expected:
        [
          { key: :C66737_C49687, previous: "Phase IIIA Trial", notation: "Phase IIIaTrial" }
        ]
      },
      { version: 4, date: "2007-05-31", expected:
        [ 
          { key: :C66790_C43234, previous: "Not reported", notation: "NOT REPORTED" },
          { key: :C67152_C20587, previous: "Age Span",     notation: "Age Group" }
        ]
      },
      { version: 5, date: "2007-06-05", expected: [] }, # No changes
      { version: 6, date: "2008-01-15", expected: [] }, # No changes
      { version: 7, date: "2008-01-25", expected: [] }, # No changes
      { version: 8, date: "2008-08-26", expected: [] }, # No changes
      { version: 9, date: "2008-09-22", expected: [] }, # No changes
      { version: 10, date: "2008-09-24", expected: [] }, # No changes
      { version: 11, date: "2008-09-30", expected: [] }, # No changes
      { version: 12, date: "2008-10-09", expected: [] }, # No changes
      { version: 13, date: "2008-10-15", expected: [] }, # No changes
      { version: 14, date: "2009-02-17", expected: [] }, # No changes
      { version: 15, date: "2009-02-18", expected:
        [ 
          { key: :C78735_C42708, previous: "PARENT", notation: "CHILD" }
        ]
      },
      { version: 16, date: "2009-05-01", expected:
        [ 
          { key: :C78735_C42708, previous: "PARENT", notation: "CHILD" },
          { key: :C67154_C74761, previous: "Albumin/Creatinine Ratio", notation: "Albumin/Creatinine" }
        ]      
      },
      { version: 17, date: "2009-07-06", expected:
        [ 
          { key: :C78735_C42708, previous: "PARENT", notation: "CHILD" },
          { key: :C67154_C64798, previous: "Ery. Mean Corpuscular HB Concentration", notation: "Ery. Mean Corpuscular HGB Concentration" }
        ]
      },
      { version: 18, date: "2009-10-06", expected:
        [ 
          { key: :C78735_C42708, previous: "PARENT", notation: "CHILD" }
        ]
      },
      { version: 19, date: "2010-03-05", expected: [] }, # No changes
      { version: 20, date: "2010-04-08", expected:
        [
          { key: :C85491_C86641, previous: "PEDIOCOCCUS SPECIES", notation: "PEDIOCOCCUS" }
        ]
      },
      { version: 21, date: "2010-07-02", expected:
        [
          { key: :C76351_C74573, previous: "TYPE5", notation: "TYPEV" }
        ]
      },
      { version: 22, date: "2010-10-06", expected:
        [
          { key: :C85491_C86456, previous: "KLEBSIELLA PNEUMONIAE SUBSP. OZAENAE", notation: "KLEBSIELLA OZAENAE" }
        ]
      },
      { version: 23, date: "2010-10-22", expected: [] }, # No changes
      { version: 24, date: "2011-01-07", expected: [] }, # No changes
      { version: 25, date: "2011-04-08", expected: 
        [
          { key: :C67154_C51951, notation: "Platelets", previous: "Platelet" }
        ]
      },
      { version: 26, date: "2011-06-10", expected: [] }, # No changes
      { version: 27, date: "2011-07-22", expected: [] }, # No changes
      { version: 28, date: "2011-12-09", expected:
        [
      ...
      { version: 29, date: "2012-03-23", expected:
        [ 
          {key: :C74456_C32973, previous: "THYROID GLAND, RIGHT LOBE", notation: "THYROID GLAND, LEFT LOBE" }
        ]
      },
      { version: 30, date: "2012-06-29", expected:
        [
          { key: :C78425_C38258, previous: "INTRAPERITEONEAL", notation: "INTRAPERITONEAL" }
        ]
      },
      { version: 31, date: "2012-08-03", expected: [] },
      { version: 32, date: "2012-12-21", expected: [] },
      { version: 33, date: "2013-04-12", expected: [] },
      { version: 34, date: "2013-06-28", expected: [] },
      { version: 35, date: "2013-10-04", expected: [] },
      { version: 36, date: "2013-12-20", expected:
        [ 
      ...
      { version: 37, date: "2014-03-28", expected: [] },
      { version: 38, date: "2014-06-27", expected:
        [ 
          { key: :C101859_C17998,  previous: "Unknown", notation: "UNKNOWN" },
          { key: :C101841_C100040, previous: "TIMI-0", notation: "GRADE 0" }
        ]
      },
      { version: 39, date: "2014-09-26", expected: [] },
      { version: 40, date: "2014-10-06", expected: [] },
      { version: 41, date: "2014-12-19", expected:
        [ 
      ...
      { version: 42, date: "2015-03-27", expected: [] },
      { version: 43, date: "2015-06-26", expected:
        [ 
          { key: :C103330_C17953, previous: "Education Level", notation: "Level of Education Attained"}
        ]
      },
      { version: 44, date: "2015-09-25", expected:
        [ 
          { key: :C111342_C111467, previous: "CSS0904B", notation: "CSS0904A"}
        ]
      },
      { version: 45, date: "2015-12-18", expected:
        [ 
      ...
      { version: 46, date: "2016-03-25", expected: [] },
      { version: 47, date: "2016-06-24", expected: [] },
      { version: 48, date: "2016-09-30", expected: [] },
      { version: 49, date: "2016-12-16", expected:
        [ 
      ...
      { version: 50, date: "2017-03-31", expected: 
        [ 
      ...
      { version: 51, date: "2017-06-30", expected:
        [ 
      ...
      { version: 52, date: "2017-09-29", expected:
        [ 
      ...
      { version: 59, date: "2019-06-28", expected: 
        [ 
