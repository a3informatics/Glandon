...
describe "Thesaurus::ManagedConcept::ManagedConcept" do
  ...
  describe "general tests" do
    ...
    def simple_thesaurus_1
      ...
      @th_1 = Thesaurus::ManagedConcept.new
      @tc_1 = Thesaurus::ManagedConcept::ManagedConcept.from_h({
          label: "London Heathrow",
          identifier: "A00001",
          definition: "A definition",
          notation: "LHR"
        })
      @tc_1.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("Heathrow")
      @tc_1.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("LHR")
      @tc_1.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.where_only_or_create("London Heathrow")
      @tc_1a = Thesaurus::ManagedConcept::UnmanagedConcept.from_h({
          label: "Terminal 5",
          identifier: "A000011",
          definition: "The 5th LHR Terminal",
          notation: "T5"
        })
      @tc_1a.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("T5")
      @tc_1a.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("Terminal Five")
      @tc_1a.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("BA Terminal")
      @tc_1a.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("British Airways Terminal")
      @tc_1a.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.where_only_or_create("Terminal 5")
      @tc_1b = Thesaurus::ManagedConcept::UnmanagedConcept.from_h({
          label: "Terminal 1",
          identifier: "A000012",
          definition: "The oldest LHR Terminal",
          notation: "T1"
        })
      @tc_1b.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.where_only_or_create("Terminal 1")
      @tc_1.narrower << @tc_1a
      @tc_1.narrower << @tc_1b
      @tc_2 = Thesaurus::ManagedConcept::ManagedConcept.new
    ...
    def simple_thesaurus_2
      @th_2 = Thesaurus::ManagedConcept.new
      @tc_3 = Thesaurus::ManagedConcept::ManagedConcept.from_h({
          label: "London Heathrow",
          identifier: "A00001",
          definition: "A definition",
          notation: "LHR"
        })
      @tc_3.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("Heathrow")
      @tc_3.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("LHR")
      @tc_3.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.where_only_or_create("London Heathrow")
      @tc_3a = Thesaurus::ManagedConcept::UnmanagedConcept.from_h({
          label: "Terminal 5",
          identifier: "A000011",
          definition: "The 5th LHR Terminal",
          notation: "T5"
        })
      @tc_3a.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("T5")
      @tc_3a.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("Terminal Five")
      @tc_3a.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("BA Terminal")
      @tc_3a.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("British Airways Terminal")
      @tc_3a.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.where_only_or_create("Terminal 5")
      params = {
          label: "Terminal 1",
          identifier: "A000012",
          definition: "The oldest LHR Terminal",
      ...
      @tc_3b = Thesaurus::ManagedConcept::UnmanagedConcept.from_h(params)
      @tc_3b.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.where_only_or_create("Terminal 1")
      @tc_3.narrower << @tc_3a
      @tc_3.narrower << @tc_3b
      @tc_4 = Thesaurus::ManagedConcept::ManagedConcept.new
    ...
    def simple_thesaurus_3
      @th_3 = Thesaurus::ManagedConcept.new
      @tc_5 = Thesaurus::ManagedConcept::ManagedConcept.from_h({
          label: "London Heathrow",
          identifier: "A00001",
          definition: "A definition",
          notation: "LHR"
        })
      @tc_5.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("Heathrow")
      @tc_5.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("LHR")
      @tc_5.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.where_only_or_create("London Heathrow")
      @tc_5c = Thesaurus::ManagedConcept::UnmanagedConcept.from_h({
          label: "Terminal X",
          identifier: "A000014",
          definition: "The new new LHR Terminal. Never going to happen",
          notation: "TX"
        })
      @tc_5c.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.where_only_or_create("Terminal X")
      @tc_5a = Thesaurus::ManagedConcept::UnmanagedConcept.from_h({
          label: "Terminal 5",
          identifier: "A000011",
          definition: "The 5th LHR Terminal",
          notation: "T5"
        })
      @tc_5a.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("T5")
      @tc_5a.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("Terminal Five")
      @tc_5a.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("BA Terminal")
      @tc_5a.synonym << Thesaurus::ManagedConcept::Synonym.where_only_or_create("British Airways Terminal")
      @tc_5a.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.where_only_or_create("Terminal 5")
      @tc_5b = @tc_1b = Thesaurus::ManagedConcept::UnmanagedConcept.from_h({
          label: "Terminal 1",
          identifier: "A000012",
          definition: "The oldest LHR Terminal",
          notation: "T1"
        })
      @tc_5b.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.where_only_or_create("Terminal 1")
      @tc_5.narrower << @tc_5a
      @tc_5.narrower << @tc_5b
      @tc_5.narrower << @tc_5c
      @tc_6 = Thesaurus::ManagedConcept::ManagedConcept.new
    ...
    it "allows validity of the object to be checked - error" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.new
    ...
    it "allows a TC to be found" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.find(Uri.new(uri:"http://www.acme-pharma.com/A00001/V1#A00001"))
      expect(tc.identifier).to eq("A00001")
    end

    it "allows a TC to be found - error" do
      expect{Thesaurus::ManagedConcept::ManagedConcept.find(Uri.new(uri:"http://www.acme-pharma.com/A00001/V1#A00001x"))}.to raise_error(Errors::NotFoundError,
        "Failed to find http://www.acme-pharma.com/A00001/V1#A00001x in Thesaurus::ManagedConcept::ManagedConcept.")
    end

    it "allows the existance of a TC to be determined" do
      expect(Thesaurus::ManagedConcept::ManagedConcept.exists?("A00001")).to eq(true)
    end

    it "allows the existance of a TC to be determined - not there" do
      expect(Thesaurus::ManagedConcept::ManagedConcept.exists?("A00001x")).to eq(false)
    end

    it "finds by properties, single" do
    	results = Thesaurus::ManagedConcept::ManagedConcept.where({identifier: "A00001"})
    	expect(results.count).to eq(1)
  	end

    it "finds by properties, multiple" do
    	results = Thesaurus::ManagedConcept::ManagedConcept.where({notation: "LHR", label: "London Heathrow"})
    	expect(results.count).to eq(1)
  	end
    ...
    it "allows a new child TC to be added" do
      ...
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_full(Uri.new(uri:"http://www.acme-pharma.com/A00001/V1#A00001"))
      check_thesaurus_concept_actual_expected(tc.to_h, sub_dir, "add_child_expected_1.yaml")
      tc = Thesaurus::ManagedConcept::UnmanagedConcept.find_children(Uri.new(uri:"http://www.acme-pharma.com/A00001/V1#A00001_NC00000456C"))
    ...
    it "prevents a duplicate TC being added" do
      ...
      expect(Thesaurus::ManagedConcept::UnmanagedConcept).to receive(:identification_configuration).twice.and_return(local_configuration)
      params =
      {
      ...
      new_object = tc.add_child(params)
      expect(new_object.errors.count).to eq(0)
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_children(Uri.new(uri:"http://www.acme-pharma.com/A00001/V1#A00001"))
      new_object = tc.add_child(params)
    ...
    it "prevents a TC being added with invalid identifier" do
      local_configuration = {scheme_type: :flat, parent: {entered: true}, child: {entered: true}} # Need to force manual entry
      expect(Thesaurus::ManagedConcept::UnmanagedConcept).to receive(:identification_configuration).and_return(local_configuration)
      params =
      {
        definition: "Other or mixed race",
        identifier: "?",
    ...
    it "allows a TC to be saved" do
      ...
      new_object.save
      tc = Thesaurus::ManagedConcept::UnmanagedConcept.find(Uri.new(uri:"http://www.acme-pharma.com/A00001/V1#A00001_NC00000456C"))
    ...
    it "allows to determine if TCs different" do
      tc1 = Thesaurus::ManagedConcept::ManagedConcept.find(Uri.new(uri:"http://www.acme-pharma.com/A00001/V1#A00001"))
      tc2 = Thesaurus::ManagedConcept::ManagedConcept.find(Uri.new(uri:"http://www.acme-pharma.com/A00002/V1#A00002"))
    ...
    it "allows to determine if TCs same" do
      tc1 = Thesaurus::ManagedConcept::ManagedConcept.find(Uri.new(uri:"http://www.acme-pharma.com/A00001/V1#A00001"))
      tc2 = Thesaurus::ManagedConcept::ManagedConcept.find(Uri.new(uri:"http://www.acme-pharma.com/A00001/V1#A00001"))
      results = tc1.diff?(tc2)
    ...
    it "allows a TC to be created from Hash" do
      ...
      tc = Thesaurus::ManagedConcept::ManagedConcept.from_h(input)
    ...
    it "allows a TC to be created" do
      object = Thesaurus::ManagedConcept::ManagedConcept.create({identifier: "A000001", notation: "A"})
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_full(object.uri)
    ...
    it "allows a TC to be destroyed" do
      object = Thesaurus::ManagedConcept::ManagedConcept.create({identifier: "AAA", notation: "A"})
      tc = Thesaurus::ManagedConcept::ManagedConcept.find(object.uri)
      result = tc.delete
      expect(result).to eq(1)
      expect{Thesaurus::ManagedConcept::ManagedConcept.find(object.uri)}.to raise_error(Errors::NotFoundError,
        "Failed to find http://www.acme-pharma.com/AAA/V1#AAA in Thesaurus::ManagedConcept::ManagedConcept.")
    end
  ...
  describe "changes and differences" do
    ...
    it "finds changes count" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C65047/V20#C65047"))
      expect(tc.changes_count(4)).to eq(4)
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C65047/V30#C65047"))
      expect(tc.changes_count(40)).to eq(29)
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C65047/V1#C65047"))
    ...
    it "finds changes, 8" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C101805/V31#C101805"))
      results = tc.changes(8)
    ...
    it "finds changes, 3" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C89973/V45#C89973"))
      results = tc.changes(3)
    ...
    it "differences, II" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C124661/V47#C124661"))
      results = tc.differences
      check_file_actual_expected(results, sub_dir, "differences_expected_2.yaml", equate_method: :hash_equal)
    end

    it "differences, III" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C100129/V56#C100129"))
      results = tc.differences
      check_file_actual_expected(results, sub_dir, "differences_expected_3.yaml", equate_method: :hash_equal)
    end

    it "differences, IV" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C100129/V31#C100129"))
      results = tc.differences
    ...
    it "differences, VI" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C101805/V37#C101805"))
      results = tc.differences
    ...
    it "differences_summary, first item first version" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C101805/V31#C101805"))
      last = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C101805/V60#C101805"))
    ...
    it "changes_summary II" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C89973/V45#C89973"))
      last = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C89973/V48#C89973"))
    ...
    it "changes_summary III" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C66783/V2#C66783"))
      last = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C66783/V27#C66783"))
  ...
  describe "updates" do
    ...
    it "add and delete extensions" do
      ...
      tc_1.save
      tc_2 = Thesaurus::ManagedConcept::ManagedConcept.from_h({
          label: "Exeter",
          identifier: "A00004",
          definition: "A definition",
          notation: "EXT"
  ...
  describe "csv test" do
    ...
    it "to csv data" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_full(Uri.new(uri: "http://www.cdisc.org/C66790/V2#C66790"))
    ...
    it "to csv 2" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_full(Uri.new(uri: "http://www.cdisc.org/C66788/V2#C66788"))
      results = tc.to_csv
  ...
  describe "child pagination" do
    ...
    it "children set" do
      ...
      results = Thesaurus::ManagedConcept::ManagedConcept.children_set(set)
      check_file_actual_expected(results, sub_dir, "child_set_expected_1.yaml")
    end

    it "normal, extended" do
      thesaurus = Thesaurus::ManagedConcept.create({identifier: "XXX", label: "YYY"})
      thesaurus = Thesaurus::ManagedConcept.find_minimum(thesaurus.uri)
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C99079/V31#C99079"))
      ...
      ext = Thesaurus::ManagedConcept::UnmanagedConcept.find(Uri.new(uri: "http://www.cdisc.org/C99078/V28#C99078_C307"))
    ...
    it "normal with tags filter" do
      tc = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri: "http://www.cdisc.org/C101806/V31#C101806"))
  ...
  describe "merge" do
    ...
    def merge_base
      ...
      @tc_1.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.new(label: "Vital Sign Test Codes Extension")
      @tc_1.tagged << @tag_1
      @tc_1a = Thesaurus::ManagedConcept::UnmanagedConcept.from_h({
          label: "APGAR Score",
          identifier: "A00002",
      ...
      @tc_1a.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.new(label: "APGAR Score")
      @tc_1b = Thesaurus::ManagedConcept::UnmanagedConcept.from_h({
      ...
      @tc_1b.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.new(label: "Mid upper arm circumference")
      @tc_1b.synonym << Thesaurus::ManagedConcept::Synonym.new(label: "Upper Arm")
      @tc_1b.tagged << @tag_1
      @tc_1b.tagged << @tag_3
      @tc_1.narrower << @tc_1a
      @tc_1.narrower << @tc_1b
      ...
      @tc_2.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.new(label: "Vital Sign Test Codes Extension")
      @tc_2.tagged << @tag_2
      @tc_2a = Thesaurus::ManagedConcept::UnmanagedConcept.from_h({
          label: "APGAR Score",
          identifier: "A00002",
          definition: "An APGAR Score",
          notation: "APGAR"
        })
      @tc_2a.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.new(label: "APGAR Score")
      @tc_2b = Thesaurus::ManagedConcept::UnmanagedConcept.from_h({
          label: "Mid upper arm circumference",
          identifier: "A00003",
          definition: "The measurement of the mid upper arm circumference",
          notation: "MUAC"
        })
      @tc_2b.preferred_term = Thesaurus::ManagedConcept::PreferredTerm.new(label: "Mid upper arm circumference")
      @tc_2b.synonym << Thesaurus::ManagedConcept::Synonym.new(label: "Upper Arm")
      @tc_2b.tagged << @tag_1
      @tc_2b.tagged << @tag_2
      @tc_2.narrower << @tc_2a
      @tc_2.narrower << @tc_2b
    ...
    it "extra child in other" do
      merge_base
      @tc_2c = Thesaurus::ManagedConcept::UnmanagedConcept.from_h({
          label: "Extra",
          identifier: "A00004",
  ...
  describe "subsets" do
    ...
    it "determines if an item is subsetted" do
      cl = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri:"http://www.cdisc.org/C66726/V19#C66726"))
    ...
    it "determines if an item is subsetted, none found" do
      cl2 = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri:"http://www.cdisc.org/C87162/V19#C87162"))
      expect(cl2.subsetted_by).to eq(nil)
    end

    it "determines if an item is a subset and finds" do
      cl = Thesaurus::ManagedConcept::ManagedConcept.find_minimum(Uri.new(uri:"http://www.s-cubed.dk/S000001/V19#S000001"))
  ...
  describe "Clone and New Version" do
    ...
    it "clone thesaurus concept I" do
      tc = Thesaurus::ManagedConcept.find_with_properties(Uri.new(uri: "http://www.acme-pharma.com/AIRPORTS/V1#TH_A00001"))
      actual = tc.clone
    ...
    it "create next thesaurus concept" do
      ...
      check_file_actual_expected(actual.to_h, sub_dir, "next_version_expected_1b.yaml", write_file: true)
      ...
      check_file_actual_expected(actual.to_h, sub_dir, "next_version_expected_1c.yaml", write_file: true)
    end
