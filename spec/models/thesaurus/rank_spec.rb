...
describe "Thesaurus::Rank" do
  ...
  describe "rank" do
    ...
    it "update rank" do
      ...
      check_file_actual_expected(actual_rank_member.to_h, sub_dir, "update_expected_1.yaml", equate_method: :hash_equal, write_file: true)
    end
    ...
    it "update rank" do
      ...
      check_file_actual_expected(actual_rank_member_1.to_h, sub_dir, "update_expected_2a.yaml", equate_method: :hash_equal, write_file: true)
      check_file_actual_expected(actual_rank_member_2.to_h, sub_dir, "update_expected_2b.yaml", equate_method: :hash_equal, write_file: true)
    end
