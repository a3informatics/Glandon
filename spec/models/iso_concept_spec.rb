...
describe IsoConcept do
  ...
  #     expect(results[0].to_s).to eq("http://www.cdisc.org/C85494/V42#C85494_C120775")  
   ...
   #    compare_link_to_results(results, expected)
	  ...
	  it "allows the links from a concept to be determined, internal to managed item hierarchy" do
	    ...
	    [ 
	      { 
	        uri: UriV2.new({uri: "http://www.assero.co.uk/MDRForms/ACME/V1#F-ACME_VSBASELINE1_G1_G1_I2"}).to_json, 
	        rdf_type: "http://www.assero.co.uk/BusinessForm#CommonItem",
          label: "Common Item",
	        local: true
	      },
	      { 
	        uri: UriV2.new({uri: "http://www.assero.co.uk/MDRForms/ACME/V1#F-ACME_VSBASELINE1_G1_G1_I1"}).to_json, 
	        rdf_type: "http://www.assero.co.uk/BusinessForm#CommonItem",
          label: "Common Item",
	        local: true 
	      }
	  ...
	  it "allows the links to a concept to be determined, BC Property Ref" do
	    ...
	    [
	      {
	        uri: UriV2.new({uri: "http://www.assero.co.uk/MDRForms/ACME/V1#F-ACME_VSBASELINE1"}).to_json,
 ...
 #      compare_cross_reference_details(result, expected)
  ...
  context "SDTM Difference Tests" do
    ...
    #   i_1 = SdtmClass::Variable.find("M-CDISC_SDTMMODELEVENTS_xxDECOD", "http://www.assero.co.uk/MDRSdtmMd/CDISC/V1")
    #   i_2 = SdtmClass::Variable.find("M-CDISC_SDTMMODELEVENTS_xxDECOD", "http://www.assero.co.uk/MDRSdtmMd/CDISC/V2")
    #   result = IsoConcept.difference(i_1, i_2, {ignore: [:ordinal]})
    ...
    #   i_1 = SdtmClass::Variable.find("M-CDISC_SDTMMODELEVENTS_xxSTTPT", "http://www.assero.co.uk/MDRSdtmMd/CDISC/V2")
    #   i_2 = SdtmClass::Variable.find("M-CDISC_SDTMMODELEVENTS_xxSTTPT", "http://www.assero.co.uk/MDRSdtmMd/CDISC/V3")
    #   result = IsoConcept.difference(i_1, i_2, {ignore: [:ordinal]})
