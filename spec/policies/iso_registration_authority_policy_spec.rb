...
describe IsoRegistrationAuthorityPolicy do

  include UserAccountHelpers
  include PermissionsHelpers

  subject { described_class.new(user, iso_registration_authority) }
  let (:iso_registration_authority) { IsoRegistrationAuthority.new }
