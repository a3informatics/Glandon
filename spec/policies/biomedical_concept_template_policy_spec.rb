...
describe BiomedicalConceptTemplatePolicy do

  include UserAccountHelpers
  include PermissionsHelpers

  subject { described_class.new(user, biomedical_concept_template) }
  let (:biomedical_concept_template) { BiomedicalConceptTemplate.new }
