...
curl -v -X POST -H "Content-Type:multipart/form-data" -F "filename=@data/cdisc/ct/CT_V70.ttl" $FileEndPoint
curl -v -X POST -H "Content-Type:multipart/form-data" -F "filename=@data/cdisc/ct/CT_V71.ttl" $FileEndPoint
...
curl -v -X POST -H "Content-Type:multipart/form-data" -F "filename=@data/cdisc/ct/changes/change_instructions_v70.ttl" $FileEndPoint
curl -v -X POST -H "Content-Type:multipart/form-data" -F "filename=@data/cdisc/ct/changes/change_instructions_v71.ttl" $FileEndPoint
# Sponsor Terminology
...
curl -v -X POST -H "Content-Type:multipart/form-data" -F "filename=@data/canonical_references_migration_2.ttl" $FileEndPoint
